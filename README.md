...
Enable http site
    ...
    sudo ln -s /etc/nginx/sites-available/fni-http.conf /etc/nginx/sites-enabled/fni-http.conf
...
Enable https site
    ...
    sudo ln -s /etc/nginx/sites-available/fni-https.conf /etc/nginx/sites-enabled/fni-https.conf
    sudo service nginx restart
