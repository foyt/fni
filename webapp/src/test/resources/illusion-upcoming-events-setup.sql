...
insert into 
  IllusionEvent (id, urlName, xmppRoom, name, description, created, folder_id, joinMode, signUpFee, signUpFeeCurrency, startDate, startTime, endDate, endTime) 
values 
  (2, 'upcoming_1', 'upcoming_1@bogustalk.net', 'Upcoming #1', 'Upcoming event #1', PARSEDATETIME('1 1 2010', 'd M yyyy'), 20010, 'OPEN', null, null, DATEADD('DAY', 1, CURRENT_DATE()), null, DATEADD('DAY', 2, CURRENT_DATE()), null);
...
insert into 
  IllusionEvent (id, urlName, xmppRoom, name, description, created, folder_id, joinMode, signUpFee, signUpFeeCurrency, startDate, startTime, endDate, endTime) 
values 
  (3, 'upcoming_2', 'upcoming_2@bogustalk.net', 'Upcoming #2', 'Upcoming event #2', PARSEDATETIME('1 1 2010', 'd M yyyy'), 20011, 'OPEN', null, null, DATEADD('DAY', -1, CURRENT_DATE()), null, DATEADD('DAY', 2, CURRENT_DATE()), null);
