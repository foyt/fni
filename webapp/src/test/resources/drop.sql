alter table Address 
    ...
    alter table IllusionGroupUser 
        drop constraint FK_bi1sqw278qxutvgpoi3d2ha3f if exists;

    alter table IllusionGroupUser 
        drop constraint FK_7liw317xxvfwqjxamx9u1rkmr if exists;

    alter table IllusionGroupUserImage 
        drop constraint FK_gh19d6kmaqyuytq6w8uhcbcv8 if exists;

    alter table IllusionGroupUserSetting 
        drop constraint FK_cdfrwkmb5ns0amc8ry94a5jhd if exists;
    ...
    drop table IllusionGroupUser if exists;

    drop table IllusionGroupUserImage if exists;

    drop table IllusionGroupUserSetting if exists;
