...
public class IllusionEventMaterialTestsBase extends AbstractIllusionUITest {
  ...
  public void testCustomDomainNavigationLinks() {
    ...
    assertEquals(getCustomEventUrl() + "/materials", findElementBySelector(".view-header-navigation .view-header-navigation-item:nth-child(7) a").getAttribute("href"));
    assertEquals(getCustomEventUrl() + "/materials/document", findElementBySelector(".view-header-navigation .view-header-navigation-item:nth-child(9) a").getAttribute("href"));
  }
