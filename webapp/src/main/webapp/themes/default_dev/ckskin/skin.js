...
CKEDITOR.skins.add( 'fni', (function()
{
...
.cke_skin_fni .cke_menuitem .cke_icon_wrapper\
{\
	background-color: $color !important;\
	border-color: $color !important;\
}\
\
.cke_skin_fni .cke_menuitem a:hover .cke_icon_wrapper,\
.cke_skin_fni .cke_menuitem a:focus .cke_icon_wrapper,\
.cke_skin_fni .cke_menuitem a:active .cke_icon_wrapper\
{\
	background-color: $color !important;\
	border-color: $color !important;\
}\
\
.cke_skin_fni .cke_menuitem a:hover .cke_label,\
.cke_skin_fni .cke_menuitem a:focus .cke_label,\
.cke_skin_fni .cke_menuitem a:active .cke_label\
{\
	background-color: $color !important;\
}\
\
.cke_skin_fni .cke_menuitem a.cke_disabled:hover .cke_label,\
.cke_skin_fni .cke_menuitem a.cke_disabled:focus .cke_label,\
.cke_skin_fni .cke_menuitem a.cke_disabled:active .cke_label\
{\
	background-color: transparent !important;\
}\
\
.cke_skin_fni .cke_menuitem a.cke_disabled:hover .cke_icon_wrapper,\
.cke_skin_fni .cke_menuitem a.cke_disabled:focus .cke_icon_wrapper,\
.cke_skin_fni .cke_menuitem a.cke_disabled:active .cke_icon_wrapper\
{\
	background-color: $color !important;\
	border-color: $color !important;\
}\
\
.cke_skin_fni .cke_menuitem a.cke_disabled .cke_icon_wrapper\
{\
	background-color: $color !important;\
	border-color: $color !important;\
}\
\
.cke_skin_fni .cke_menuseparator\
{\
	background-color: $color !important;\
}\
\
.cke_skin_fni .cke_menuitem a:hover,\
.cke_skin_fni .cke_menuitem a:focus,\
.cke_skin_fni .cke_menuitem a:active\
{\
	background-color: $color !important;\
}";
