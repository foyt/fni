...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/themes/default_dev/css/forge.css" />
<script src="${pageContext.request.contextPath}/resources/scripts/gui/forge/formselectfield.js" type="text/javascript"></script>
...
<script src="${pageContext.request.contextPath}/resources/scripts/gui/forge/workspacewindowdockingbar.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/resources/scripts/gui/forge/workspacecontroller.js" type="text/javascript"></script>
