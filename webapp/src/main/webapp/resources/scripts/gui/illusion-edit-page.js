  ...
  $(document).ready(function () {
    ...
    var editor = $('.illusion-page-editor').coOpsCK({
      externalPlugins: {
        ...
        'change': '//cdn.metatavu.io/libs/coops-ckplugins/change/0.1.1/plugin.min.js',
        'coops': '//cdn.metatavu.io/libs/coops-ckplugins/coops/0.1.1/plugin.min.js',
        'coops-connector': '//cdn.metatavu.io/libs/coops-ckplugins/coops-connector/0.1.1/plugin.min.js',
        'coops-dmp': '//cdn.metatavu.io/libs/coops-ckplugins/coops-dmp/0.1.1/plugin.min.js',
        'coops-cursors': '//cdn.metatavu.io/libs/coops-ckplugins/coops-cursors/0.1.1/plugin.min.js',
        'coops-sessionevents': '//cdn.metatavu.io/libs/coops-ckplugins/coops-sessionevents/0.1.1/plugin.min.js',
