...
create table IllusionEventDocument (
    documentType varchar(255) not null,
    id bigint not null,
    primary key (id)
);

create table IllusionEventFolder (
    id bigint not null,
    primary key (id)
);

create table IllusionEventGroup (
    id bigint generated by default as identity,
    name varchar(255),
    event_id bigint,
    primary key (id)
...
create table IllusionEventGroupMember (
    id bigint generated by default as identity,
    group_id bigint,
...
create table IllusionEventMaterialParticipantSetting (
    id bigint generated by default as identity,
...
create table IllusionEventParticipant (
    id bigint generated by default as identity,
...
create table IllusionEventParticipantImage (
    id bigint generated by default as identity,
...
create table IllusionEventParticipantSetting (
    id bigint generated by default as identity,
    settingKey varchar(255) not null,
    value varchar(255),
    participant_id bigint,
...
create table IllusionEventSetting (
    id bigint generated by default as identity,
    settingKey varchar(255) not null,
    value varchar(255),
    event_id bigint,
...
alter table IllusionEvent 
    add constraint UK_h3mv1foemekyth1ueftkflogd  unique (urlName);

alter table IllusionEvent 
    add constraint UK_7xnvhwxxtdwv39xt3maolanvt  unique (xmppRoom);
...
alter table CharacterSheet 
    add constraint FK_lpi2b27avc79sx937mubrud30 
    foreign key (id) 
    references Material;
...
alter table IllusionEvent 
    add constraint FK_pnx62d5p6cd30kcm5h7juxedh 
    foreign key (folder_id) 
    references IllusionEventFolder;

alter table IllusionEventDocument 
    add constraint FK_fve30yc3ynmjb6vv16bbwl9fg 
    foreign key (id) 
    references Document;

alter table IllusionEventFolder 
    add constraint FK_7oupprekwkv2de8e800s3uvhd 
    foreign key (id) 
    references Folder;

alter table IllusionEventGroup 
    add constraint FK_hvj6d2eq0goiekm7g8vobtpw 
    foreign key (event_id) 
    references IllusionEvent;

alter table IllusionEventGroupMember 
    add constraint FK_7rqot7m90nutqrb0uyqauitck 
    foreign key (group_id) 
    references IllusionEventGroup;

alter table IllusionEventGroupMember 
    add constraint FK_f05t51bu9usvp19xuxfocngc 
    foreign key (participant_id) 
    references IllusionEventParticipant;

alter table IllusionEventMaterialParticipantSetting 
    add constraint FK_nc6hjnc90f1lqap86tc9a11hi 
    foreign key (material_id) 
    references Material;

alter table IllusionEventMaterialParticipantSetting 
    add constraint FK_d3bdnu688r7k3dmh8nkcagd4s 
    foreign key (participant_id) 
    references IllusionEventParticipant;

alter table IllusionEventParticipant 
    add constraint FK_rx0fsg3gh29ufysfcy17179va 
    foreign key (event_id) 
    references IllusionEvent;

alter table IllusionEventParticipant 
    add constraint FK_1mvh1yu0u4nygql9wvjoqlotw 
    foreign key (user_id) 
    references User;

alter table IllusionEventParticipantImage 
    add constraint FK_ejrnsfjokg9qttd3mkr7w9gr6 
    foreign key (participant_id) 
    references IllusionEventParticipant;

alter table IllusionEventParticipantSetting 
    add constraint FK_khs05wuhk2wd1fen2l3ckhxpc 
    foreign key (participant_id) 
    references IllusionEventParticipant;

alter table IllusionEventSetting 
    add constraint FK_c0yxx6dlxdp2v1x378onaowyg 
    foreign key (event_id) 
    references IllusionEvent;
...
alter table OrderItem 
    add constraint FK_lofm76ekoru7fjp5xtnm2lhb6 
    foreign key (illusionEvent_id) 
    references IllusionEvent;
