...
values 
  (2, 'open', 'open@bogustalk.net', 'Open', 'Event for automatic testing (Open)', PARSEDATETIME('1 1 2010', 'd M yyyy'), 20002, 'OPEN', 10, null, PARSEDATETIME('1 1 2010', 'd M yyyy'), PARSEDATETIME('2 1 2010', 'd M yyyy'), true, 'JOIN'),
  (3, 'approve', 'approve@bogustalk.net', 'Approve', 'Event for automatic testing (Approve)', PARSEDATETIME('1 1 2010', 'd M yyyy'), 20003, 'APPROVE', 20, null, PARSEDATETIME('1 1 2010', 'd M yyyy'), PARSEDATETIME('2 1 2010', 'd M yyyy'), true, 'JOIN'),
  (4, 'invite', 'invite@bogustalk.net', 'Invite Only', 'Event for automatic testing (Invite Only)', PARSEDATETIME('1 1 2010', 'd M yyyy'), 20004, 'INVITE_ONLY', 30, null, PARSEDATETIME('1 1 2010', 'd M yyyy'), PARSEDATETIME('2 1 2010', 'd M yyyy'), true, 'JOIN');
