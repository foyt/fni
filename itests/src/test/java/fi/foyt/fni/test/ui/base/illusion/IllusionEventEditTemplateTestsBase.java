...
@DefineSqlSets ({
  ...
  @DefineSqlSet (id = "event-organizer", 
      before = { "basic-users-setup.sql","illusion-basic-setup.sql", "illusion-event-setup.sql", "illusion-event-open-organizer-setup.sql", "illusion-event-open-templates-setup.sql" },
      after = { "illusion-event-open-templates-teardown.sql", "illusion-event-open-organizer-teardown.sql", "illusion-event-teardown.sql", "illusion-basic-teardown.sql","basic-users-teardown.sql"}
  ),
  @DefineSqlSet (id = "event-custom", 
    before = { "basic-users-setup.sql","illusion-basic-setup.sql", "illusion-event-setup.sql", "illusion-event-open-custom-setup.sql", "illusion-event-open-organizer-setup.sql", "illusion-event-open-templates-setup.sql" },
    after = { "illusion-event-open-templates-teardown.sql", "illusion-event-open-organizer-teardown.sql", "illusion-event-open-custom-teardown.sql", "illusion-event-teardown.sql", "illusion-basic-teardown.sql","basic-users-teardown.sql"}
  ),
  @DefineSqlSet (id = "event-participant", 
    before = { "basic-users-setup.sql","illusion-basic-setup.sql", "illusion-event-setup.sql", "illusion-event-open-participant-setup.sql", "illusion-event-open-templates-setup.sql" },
    after = { "illusion-event-open-templates-teardown.sql", "illusion-event-open-participant-teardown.sql", "illusion-event-teardown.sql", "illusion-basic-teardown.sql","basic-users-teardown.sql"}
  )
})
