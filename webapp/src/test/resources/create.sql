    ...
    create table IllusionGroupUser (
        id bigint generated by default as identity,
    ...
    create table IllusionGroupUserImage (
        id bigint generated by default as identity,
    ...
    create table IllusionGroupUserSetting (
        id bigint generated by default as identity,
        settingKey varchar(255) not null,
        value varchar(255),
        user_id bigint,
    ...
    alter table IllusionGroupUser 
        add constraint FK_bi1sqw278qxutvgpoi3d2ha3f 
        foreign key (group_id) 
        references IllusionGroup;

    alter table IllusionGroupUser 
        add constraint FK_7liw317xxvfwqjxamx9u1rkmr 
        foreign key (user_id) 
        references User;

    alter table IllusionGroupUserImage 
        add constraint FK_gh19d6kmaqyuytq6w8uhcbcv8 
        foreign key (user_id) 
        references IllusionGroupUser;

    alter table IllusionGroupUserSetting 
        add constraint FK_cdfrwkmb5ns0amc8ry94a5jhd 
        foreign key (user_id) 
        references IllusionGroupUser;
    ...
    alter table VectorImageRevision 
   	...
   	alter table CoOpsSession add constraint FK_wob1x94bufe9nqq8bclvnhy7 foreign key (material_id) references Material;
	alter table CoOpsSession add constraint FK_gxfr8cvpe9c53dck2nt6ujrqs foreign key (user_id) references User;