...
values 
  ('user-client-id', 'user-client-secret', 'test-user-client', 'USER', 'http://dev.forgeandillusion.net:8080/fake-redirect', null),
  ('admin-client-id', 'admin-client-secret', 'test-admin-client', 'USER', 'http://dev.forgeandillusion.net:8080/fake-redirect', null),
  ('guest-client-id', 'admin-guest-secret', 'test-guest-client', 'USER', 'http://dev.forgeandillusion.net:8443/fake-redirect', null);
