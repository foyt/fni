  ...
  $(document).ready(function () {
    ...
    var editor = $('.illusion-page-editor').coOpsCK({
      externalPlugins: {
        ...
        'change': '//static.forgeandillusion.net/libs/coops-ckplugins/change/0.1.1/plugin.min.js',
        'coops': '//static.forgeandillusion.net/libs/coops-ckplugins/coops/0.1.1/plugin.min.js',
        'coops-connector': '//static.forgeandillusion.net/libs/coops-ckplugins/coops-connector/0.1.1/plugin.min.js',
        'coops-dmp': '//static.forgeandillusion.net/libs/coops-ckplugins/coops-dmp/0.1.1/plugin.min.js',
        'coops-cursors': '//static.forgeandillusion.net/libs/coops-ckplugins/coops-cursors/0.1.1/plugin.min.js',
        'coops-sessionevents': '//static.forgeandillusion.net/libs/coops-ckplugins/coops-sessionevents/0.1.1/plugin.min.js',
